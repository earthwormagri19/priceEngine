...
A simple records system using MongoDB, Express.js, React.js, and Node.js with real-time Create, Read, Update, and Delete operations. REST API was implemented on the back-end. Semantic UI React was used for the UI.
...
Demo: [https://eaops1.herokuapp.com/)
...
```bash
git clone https://github.com/earthwormagri19/earthworm_ops.git
```
